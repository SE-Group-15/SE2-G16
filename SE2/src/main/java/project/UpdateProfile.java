...
public class UpdateProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\DELL\\Documents\\GitHub\\SE2-G16\\SE2\\logose.png")); // NOI18N
    ...
    String currentMeterNumber = account.UserData(); // Get the current meter number

    
    account.UpdateProfile(newName, newEmail, currentMeterNumber, currentMeterNumber);
    populateFields();// Use existing meter number for confirmation
  ...
  private void populateFields() {
    ...
    jTextField2.setText(account.Username1());
    jTextField3.setText(account.UserData()); 
  }
    /**
