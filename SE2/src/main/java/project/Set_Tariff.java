 ...
 * @author DELL
 */
public class Set_Tariff extends javax.swing.JFrame {
    
    Adminn admin;
    
    /**
     * Creates new form Set_Tariff
     */
    public Set_Tariff() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chip-1");

        jLabel2.setText("Chip-2");

        jLabel3.setText("Chip-3");

        jLabel4.setText("Chip-4");
        ...
        jLabel5.setText("Change Tariff Rates");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(c2, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
                                .addComponent(c4))
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
         ...
         admin.Updatetariff(D1, D2, D3, D4);
    ...
    double C1 = admin.Getc1();
    double C2 = admin.Getc2();
    double C3 = admin.Getc3();
    double C4 = admin.Getc4();
    
    String C11 = String.valueOf(C1);
    String C22 = String.valueOf(C2);
    String C33 = String.valueOf(C3);
    String C44 = String.valueOf(C4);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Set_Tariff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Set_Tariff().setVisible(true);
            }
        });
    }
